...
void            ft_malloc_tab(t_map *map, t_data *data)
{
    int         i;
...
void            ft_find_carac(t_map *map, t_data *data)
{
    int         i;
    int         j;
...
void            ft_resolve(t_map *map, t_data *data)
{
    ...
    printf("malloc ok\n");
    cpy_tab(map, data);
    printf("Copier le tableau OK\n");
    printf_tab(map, data);
    printf("afficher map OK \n");
    ft_find_carac(map, data);
    printf("charac = %d et %d\n", map->x_c, map->y_c);
    find_object(map, data);
    printf("LA CARTE EST OK =)\n");
    printf_tab(map, data);
}